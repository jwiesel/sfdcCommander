...
public final class UiLayout {
    ...
    public static final int FIELD_WIDTH = 235;
    ...
    public static final String LABEL_FIELD_COLUMN_LAYOUT = "[" + LABEL_WIDTH
            + "] 20 [" + FIELD_WIDTH + "]";
    public static final String LABEL_FIELD_ROW_INSET_LAYOUT = "insets 0, wrap 2";
    ...
    public static final String LABEL_GAP = "gap 10";
