...
public class SaveResult  implements java.io.Serializable {
    ...
    /**
     * Gets the fullName value for this SaveResult.
     * 
     * @return fullName
     */
    ...
    /**
     * Sets the fullName value for this SaveResult.
     * 
     * @param fullName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.sforce.com/2006/04/metadata", "SaveResult"));
