...
public class DeviceType implements java.io.Serializable {
    ...
    public static final java.lang.String _minitablet = "minitablet";
    public static final DeviceType phone = new DeviceType(_phone);
    public static final DeviceType tablet = new DeviceType(_tablet);
    public static final DeviceType minitablet = new DeviceType(_minitablet);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.sforce.com/2006/04/metadata", "DeviceType"));
    }
    /**
