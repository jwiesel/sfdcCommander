...
public class DeleteResult  implements java.io.Serializable {
    ...
    /**
     * Gets the fullName value for this DeleteResult.
     * 
     * @return fullName
     */
    ...
    /**
     * Sets the fullName value for this DeleteResult.
     * 
     * @param fullName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.sforce.com/2006/04/metadata", "DeleteResult"));
